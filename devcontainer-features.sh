...
usage() {
    ...
    echo ""
    echo "Commands:"
    echo "  build      Build all features or specific features"
    echo "  test       Run tests (syntax, features, or specific features)"
    ...
    echo "  $0 build kubectl helm              # Build only kubectl and helm"
    echo ""
    echo "  $0 test                            # Run all tests"
    echo "  $0 test syntax                     # Run syntax tests only"
    echo "  $0 test features                   # Run all feature tests"
    echo "  $0 test markitdown-in-docker       # Test specific feature"
    echo "  $0 test features kubectl helm      # Test multiple features"
    echo ""
