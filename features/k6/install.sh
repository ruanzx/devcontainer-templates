...
log_info ""
log_info "🎉 k6 is ready for JavaScript-based load testing!"
log_info ""
log_info "Node.js dependency:"
log_info "  This feature installs after Node.js for JavaScript ecosystem compatibility"
log_info "  Use npm to manage k6 extensions and JavaScript dependencies"
log_info ""
log_info "Quick start:"
log_info "  k6 run script.js                    # Run a load test"
log_info "  k6 run --vus 10 --duration 30s script.js  # 10 virtual users for 30s"
log_info ""
log_info "Example test script (test.js):"
log_info "  import http from 'k6/http';"
log_info "  import { check } from 'k6';"
log_info "  export default function () {"
log_info "    let response = http.get('https://httpbin.org');"
log_info "    check(response, { 'status is 200': (r) => r.status === 200 });"
log_info "  }"
